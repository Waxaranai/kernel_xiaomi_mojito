...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		git clone --depth=1 https://github.com/KenHV/gcc-arm64.git gcc64
		git clone --depth=1 https://github.com/KenHV/gcc-arm.git gcc32
	...
	then
		...
		git clone --depth=1 https://gitlab.com/venom-stark/legionx-clang.git clang-llvm
